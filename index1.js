...
const posicaoInicial = parseInt(gets());  //get para inserção dod valores de entrada
const totalPassos = parseInt(gets());//get para inserção dod valores de entrada
...
//tambem imprimir a posição final
